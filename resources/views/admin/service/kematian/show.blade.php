        ...
        <div class="container p-4">
            ...
            <div class="detail">
                ...
                <div class="grid grid-cols-3 gap-3">
                    ...
                    <div class="mb-4 P-4">
                        <h4 class="block text-gray-800 text-sm font-bold mb-2" for="alamat">Surat Keterangan dari Rumah
                            Sakit:</h4>
                        <img src="{{ asset('storage/'.$data->sk_rs) }}" alt="{{ $data->sk_rs }}">
                    </div>
                    <div class="mb-4 P-4">
                        <h4 class="block text-gray-800 text-sm font-bold mb-2" for="alamat">Surat Keterangan PBB:</h4>
