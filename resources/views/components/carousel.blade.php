<div class="">
    <div class="slideshow-container">
        ...
        <div class="mySlides fade">
            ...
            <div class="text text-white text-xl bg-blue-500 bg-opacity-80">Pengasinan Ikan Asin di Pulau Kota Karang
            </div>
        </div>

        <div class="mySlides fade">
            <img src="{{ asset('image/carousel/tambak.jpg') }}" class="h-96 object-cover" style="width:100%">
            <div class="text text-white text-xl bg-blue-500 bg-opacity-80">Beberapa Kolam milik warga desa Kota Karang
            </div>
        </div>
