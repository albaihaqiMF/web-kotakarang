...
<div x-data="{ showModal : false }">
    ...
    <button @click="showModal = !showModal"
        class="px-4 py-2 text-sm bg-{{$color}}-500 rounded-lg border transition-colors duration-150 ease-linear border-gray-200 text-white hover:text-{{$color}}-500 focus:outline-none focus:ring-0 font-bold hover:bg-gray-50 focus:bg-indigo-50 focus:text-indigo">{{$button}}</button>
